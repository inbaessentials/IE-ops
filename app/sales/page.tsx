...
export default function SalesPage() {
  ...
  // ==========================================
  // GYM SERVICES PLATFORM REVENUE VIEW (PRD 1.0)
  // ==========================================
  ...
  return (
    <>
      <div className="space-y-6 print:hidden">
        ...
        {/* Create Order Drawer */}
        <Drawer isOpen={isAddDrawerOpen} onClose={() => setIsAddDrawerOpen(false)} title={(platform as string) === "online-course" ? "Create Enrollment" : "Create Sales Order"} size="xl">
          <form className="space-y-4 pb-20" onSubmit={handleCreateOrder}>
            ...
            <div className="flex bg-slate-100/80 p-1.5 rounded-2xl border border-slate-200/50 gap-1.5 mb-6 select-none shadow-xs">
              {[
                { id: "customer", label: (platform as string) === "online-course" ? "Student Info" : "Customer Info", icon: User },
                { id: "products", label: (platform as string) === "online-course" ? "Course Program" : "Product Info", icon: ShoppingBag },
                { id: "checkout", label: (platform as string) === "online-course" ? "Pricing Setup" : "Pricing & Shipping", icon: CreditCard }
              ].map((tab) => {
                const Icon = tab.icon;
              ...
              <div className="space-y-4 animate-in fade-in duration-200">
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm space-y-6">
                  ...
                  <div>
                    ...
                    <Select 
                      options={(platform as string) === "online-course" ? ["UPI", "Credit Card", "Debit Card", "Net Banking", "Razorpay", "Cash"] : ["UPI / Online", "Cash on Delivery (COD)", "Bank Transfer"]}
