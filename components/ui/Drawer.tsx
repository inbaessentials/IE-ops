      ...
      {isOpen && (
        <>
          ...
          <motion.div 
            ...
            className={`fixed top-0 bottom-0 right-0 z-[101] w-full ${widthClass} bg-white shadow-2xl flex flex-col m-0 p-0 border-0`}
          >
            ...
            {showExitConfirm && (
              <div className="fixed inset-0 z-[102] flex items-center justify-center p-4">
                ...
                <motion.div 
                  ...
                  transition={{ duration: 0.15 }}
                  className="relative bg-white rounded-2xl shadow-2xl border border-gray-100 max-w-sm w-full p-6"
                >
